...
<#
    ...
    Start script generated by ServerPackCreator 8.0.8.
    The template which was used in the generation of this script can be found at:
    https://github.com/Griefed/ServerPackCreator/blob/8.0.8/serverpackcreator-api/src/main/resources/de/griefed/resources/server_files/default_template.ps1
...
Write-Host "Start script generated by ServerPackCreator 8.0.8."
